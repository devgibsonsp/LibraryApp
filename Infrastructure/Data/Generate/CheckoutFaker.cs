...
namespace Infrastructure.Data.Generate
{
    ...
    {
        public static List<Checkout> GenerateCheckouts(int count, List<Book> books, List<User> users)
        {
            var checkoutFaker = new Faker<Checkout>()
                ...
                .RuleFor(c => c.CustomerId, f => f.PickRandom(users).Id) // Pick a random User and use their Id
